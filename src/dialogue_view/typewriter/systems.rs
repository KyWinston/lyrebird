use crate::{
    ...
    soundfont::{events::SFplayEvent, resources::SoundFonts},
};
use bevy::prelude::*;

use super::{events::TypewriterFinishedEvent, resources::Typewriter, UNNAMED};
...
pub fn write_text(
    ...
    mut sf_ev: EventWriter<SFplayEvent>,
