...
pub fn init_instrument_list(mut commands: Commands) {
    commands.insert_resource(InstrumentList(vec![
        ...
        Instrument::new(
            ...
            0.5,
            format!(
                "{}\n~bg_pitch: ~t2_bg_melody >> mul 50.0\n~bg_evp: ~t2_bg_melody >> envperc 0.001 0.2\nbass: saw ~bg_pitch >> lpf 700 0.5 >> mul ~bg_evp",
        ...
        Instrument::new(
            ...
            0.8,
            concat!(
                "~bd_env: ~t3_bd_beat >> envperc 0.001 0.3\n",
                "~bd_envb: ~t3_bd_beat >> envperc 0.001 0.3 >> mul 200.0\n",
